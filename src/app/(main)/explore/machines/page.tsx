  ...
  return (
    <div className="bg-[#0B1220] min-h-screen text-white">
        <header className="sticky top-0 z-50 flex items-center p-4 bg-[#0B1220]/80 backdrop-blur-lg">
            ...
            <h1 className="text-xl font-bold mx-auto">Machine & Tech</h1>
        </header>
        <main className="p-4">
            <motion.div 
            ...
            >
                ...
                <p className="text-gray-400 mt-2">This section is under development. Please check back later for updates on modern farming equipment.</p>
            </motion.div>
        </main>
    </div>
  );
